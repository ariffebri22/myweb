...
export const HeroParallax = ({ products }) => {
    ...
    return (
        <div
            ref={ref}
            className="h-[330vh] py-20 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
        >
            <Header />
            <motion.div
                style={{
...
export const Header = () => {
    return (
        <div
            className="max-w-7xl relative mx-auto py-20 md:py-40 px-20 w-full left-0 top-0"
            data-aos="fade-up"
