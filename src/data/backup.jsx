<section
    id="contact"
    className="flex justify-center items-center w-full h-screen antialiased bg-grid-white/[0.02]"
>
    <div className="max-w-screen-2xl m-auto">
        ...
        >
            ...
            <p className="text-neutral-300 text-sm text-center mt-2 max-w-[30rem]">
                Do you have a project? Perhaps I can assist you. Or are you
                looking to expand your network? Feel free to contact me. I
                eagerly look forward to connecting with you!
            </p>
        </div>
        <div className="flex w-[80vw] items-center justify-center md:h-[60vh] flex-col md:flex-row">
            <div className="hidden flex-1 relative  w-full md:flex justify-center items-center">
            ...
            <div className="flex-1 relative w-full flex items-start justify-center bg-slate-200">
                <div className="login-box w-[35rem] 2xl:w-[45rem] px-10">
                    <form
                        ref={formRef}
